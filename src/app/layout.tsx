  ...
  "@graph": [
    {
      ...
      description:
        "SoterCare provides IoT and ML-based elderly care monitoring systems featuring fall detection, vital sign monitoring, and caregiver alerts.",
    ...
    },
    {
      ...
      description:
        "The SoterCare mobile application provides real-time health monitoring, AI-powered health summaries, fall alerts, and vital sign tracking for elderly care.",
    ...
    },
    {
      ...
      name: "SoterCare Kit",
      description:
        "The essential hardware kit for elderly care monitoring. Includes the Thigh Node, Wrist Node, and the Edge Gateway for seamless, offline-ready monitoring with AI-powered fall detection and vital sign tracking.",
      brand: {
        "@type": "Brand",
        name: "SoterCare",
      },
...
export const metadata: Metadata = {
  ...
  description:
    "SoterCare is an IoT and ML-based elderly care monitoring system featuring AI-powered fall detection, real-time vital sign monitoring (heart rate, SpO2), and instant caregiver alerts. Keep your loved ones safe with proactive health monitoring.",
  keywords: [
