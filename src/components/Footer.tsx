        ...
        <div className="relative z-10 flex flex-col flex-grow justify-between">
          ...
          <div className="flex-grow flex flex-col items-center justify-center p-8 text-center mt-20">
            <h2 className="mb-4 md:mb-2 leading-[1.1] md:leading-[1]">
              <span className="block text-2xl sm:text-4xl md:text-[4vh] font-medium opacity-60 text-[#2f2f2f] leading-none">
                That&apos;s our story
              </span>
          ...
          <div className="w-full px-8 pb-8 pt-20">
            <div className="border-t border-white pt-8 flex flex-col xl:flex-row justify-between items-center text-sm md:text-base text-gray-400 gap-6 md:gap-4 relative">
              {/* Copyright */}
              <div className="text-white order-3 xl:order-1 text-center xl:text-left w-full xl:w-auto">
                &copy; {new Date().getFullYear()} SoterCare. | All Rights Reserved.
              </div>

              {/* Contact Info */}
              <div className="order-1 xl:order-2 text-white  flex flex-col md:flex-row gap-4 md:gap-8 items-center xl:absolute xl:left-1/2 xl:-translate-x-1/2">
              ...
              {/* Socials & Links */}
              <div className="flex flex-col text-white md:flex-row gap-6 md:gap-8 order-2 xl:order-3 items-center">
