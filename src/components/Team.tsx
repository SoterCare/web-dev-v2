...
const Team = () => {
  ...
  return (
    <section
      id="team"
      ref={sectionRef}
      className="relative z-10 pt-24 pb-24 overflow-hidden bg-transparent scroll-mt-24 md:scroll-mt-28 md:pt-32"
    >
      <div
        ref={contentRef}
                  ...
                  <div className="flex flex-col items-center gap-4 p-6 pt-2 border-t border-black/5">
                    ...
                    <div className="flex items-center gap-4 pt-1">
                      <a
                        ...
                        className="p-2 transition-all bg-white rounded-full shadow-sm text-foreground/70 hover:text-black hover:scale-110"
                      >
                        <Github size={18} />
                      </a>
                      <a
