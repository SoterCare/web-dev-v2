            ...
            <div className="w-full max-w-7xl mx-auto px-8">
                <div className="flex flex-col gap-12">
                    ...
                    <div className="flex flex-col gap-4 items-center text-center">
                        ...
                        <h2 className="text-4xl md:text-6xl font-bold">From Our Blog</h2>
                    ...
                    <div className="flex justify-center mt-8">
                        <Link
                            href="/blog"
                            className="px-8 py-4 bg-foreground text-background rounded-full font-bold hover:bg-foreground/80 transition-colors flex items-center gap-2"
                        >
